%In this file the feature extraction is implemented for testing the Gaussian Mixture Models. 
...
%procedure for 20 images .jpeg in order for the algorithm Gaussian Mixture
%Model to test the approximate gmm models of the problem. 
%
% IMPORTANT NOTE: THIS FILE MUST BE CONTAINED IN THE SAME FOLDER AS THE
% 20 IMAGES OF THE DATASET FOR TESTING!
clc;
clear all;
initialFeatureVector=zeros(1,7);
initializeClasses=zeros(1);
for k=51:65 % RUN THIS FROM 51:65 AND 67:71 AND MERGE BOTH OF THEIR RESULTS!  
...
classes=col;
characteristics=[IntenseMean mesodif_column dIxy_column above_thres homogen];  
...
save('final_results','newCharacteristics','classesnew');